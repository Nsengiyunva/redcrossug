  ...
  Future<void> fetchMemberProfile() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Initialize location selections based on profile
        final districtName = profile.value?.district ?? '';
        if (districtName.isNotEmpty && districts.isNotEmpty) {
          final dId = idFromListByName(districts, districtName);
          if (dId.isNotEmpty) {
...
class _MembershipCardState extends State<MembershipCard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (controller.profile.value == null) {
          return _buildNonMemberScreen(context);
        }

        return _buildMemberScreen(context);
      }),
    );
  }

  Widget _buildNonMemberScreen(BuildContext context) {
            ...
            child: Column(
              ...
              children: [
                ...
                _buildBenefitCard(
                  ...
                  description:
                      'Join thousands of volunteers making a real impact in communities across Uganda.',
                  color: const Color(0xFFE31E24),
                ),
                _buildBenefitCard(
                  context,
                  ...
                  description:
                      'Access free first aid and emergency response training programs.',
                ...
                _buildBenefitCard(
                  ...
                  description:
                      'Receive your official membership card and access exclusive member events.',
                ...
                _buildBenefitCard(
                  ...
                  description:
                      'Be at the forefront of disaster relief and humanitarian assistance.',
                ...
                _buildBenefitCard(
                  ...
                  description:
                      'Gain valuable skills and certifications in humanitarian work.',
  ...
  Widget _buildMemberScreen(BuildContext context) {
    return Stack(
      children: [
        CustomScrollView(
          controller: _scrollController,
              ...
              child: Column(
                children: [
                  Container(
                    key: _cardKey,
                    child:
                        _buildEnhancedMembershipCard(controller.profile.value!),
                  ),
                  const SizedBox(height: 20),
                  _buildProfileDetails(context),
                  const SizedBox(height: 20),
  ...
  Widget _buildEnhancedMembershipCard(MemberProfile profile) {
    return LayoutBuilder(
      builder: (context, constraints) {
        final screenWidth = MediaQuery.of(context).size.width;
        final isTablet = screenWidth > 600;
        final cardMargin = isTablet ? 40.0 : 20.0;
        final cardPadding = isTablet ? 30.0 : 20.0;
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          if (profile.branch.name.isNotEmpty)
                            Container(
                              padding: const EdgeInsets.symmetric(
                                  horizontal: 12, vertical: 6),
                              decoration: BoxDecoration(
  ...
  Widget _buildProfileDetails(BuildContext context) {
    ...
    final containerPadding = isTablet ? 25.0 : 20.0;
  ...
  Widget _buildLocationInfo(MemberProfile profile) {
    return Column(
      children: [
        _buildInfoRow('District', profile.district, false),
        _buildInfoRow('Subcounty', profile.memberSubcounty, false),
  ...
  Widget _buildInfoRow(String label, String value, bool isEditable) {
    final screenWidth = MediaQuery.of(context).size.width;
    final isTablet = screenWidth > 600;
    final labelWidth = isTablet ? 160.0 : 130.0;
