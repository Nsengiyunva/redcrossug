...
class _CreateIncidentReportScreenState extends State<CreateIncidentReport> {
  ...
  /// Contact Phone — replaced the plain digits-only field with the
  /// shared searchable dial-code + flag picker, styled to match this
  /// form's other bordered radius-8 fields (see _buildTextField below).
  Widget _buildContactPhoneField() {
    return Column(
      ...
      children: [
        ...
        PhoneFormField(
          controller: _contactController,
          initialIso2: findCountryByDialCode(_selectedContactPhoneCode).iso2,
          onCountryChanged: (code) => _selectedContactPhoneCode = code,
  ...
  Future<void> _submitReport() async {
    ...
    final requestData = {
      ...
      "location_address": _locationController.text,
      "contact_number":
          "+$_selectedContactPhoneCode${_contactController.text.trim()}",
      "incident_type": selectedIncidentType,
      "severity": selectedSeverity,
      "latitude": _latitudeController.text,
      "longitude": _longitudeController.text,
