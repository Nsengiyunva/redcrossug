      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          children: [
            ...
            const SizedBox( height: 10 ),
            FormPassword( question: 'Password', textEditingController: _loginController.registerPassword ),
            const SizedBox( height: 10 ),
            FormPassword( question: 'Confirm Password', textEditingController: _loginController.registerConfirmPassword ),
            const SizedBox( height: 10 ),
            const Row(
              children: [
                Icon(
